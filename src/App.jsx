...
function App() {
    ...
    const top100Films = ['Schindler\'s List', "Schindler's List", "Schindler's List", "Schindler's List"]
    const countries = [
  ...
  return (
    <>
     <h1>MUI X</h1>
        ...
        <Button onClick={() => setShowAlert(!showAlert)} variant="outlined" color="error">
            Show Alert
        </Button>
        <CircularProgress />
    </>
